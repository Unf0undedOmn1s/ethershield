# Ιδέα με μια πρόταση (in short): Προσφέρουμε στοχευμένη προστασία απέναντι σε απειλές που δεν εντοπίζονται από τα κλασικά antivirus.
...
*Τα περισσότερα router και λειτουργικά συστήματα παρέχουν βασική ασφάλεια. Δεν εντοπίζουν όμως ασυνήθιστη δραστηριότητα, ή εσωτερικό phishing — εκεί επεμβαίνουμε εμείς.*
